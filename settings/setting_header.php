					...
					<div class="navbar-collapse collapse" id="bs-example-navbar-collapse-1" align="center" style="font-family: Segoe UI; font-size: 98%;">
								<div class="container-fluid">	
									<ul class="nav navbar-nav" style="margin: 2px 0 0 -15px;">
										...
										if($account['account_type'] == "System Administrator"){
											?>
											<li><a href="../settings/suppliers.php" data-toggle="tooltip" title="Manage System Settings."><button type="button" class="btn btn-info" style="margin-bottom:-8px; margin-top:-11px;"><i class="zmdi zmdi-settings zmdi-hc-lg"></i>&nbsp;&nbsp;Settings</button></a></li>
											<?php
										}else{
											print "";
										}
