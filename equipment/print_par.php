...
$pdf->SetFont('Arial','B',14);
	...
	$pdf->SetFont('Arial','B',10);
	$pdf->Cell(25,8,'Item No.','LB', 0, 'L');
	$pdf->Cell(60,8,'Serial No.','LB', 0, 'L');
	$pdf->Cell(60,8,'Property No.','LB', 0, 'L');
	$pdf->Cell(45,8,'Status','LBR', 1, 'L');
	...
	$pdf->SetFont('Arial','',10);
	$pdf->Cell(25,8,$count,'LBR', 0, 'C');
	$pdf->Cell(60,8,$getdata['serialnum'],'BR', 0, 'C');
	$pdf->Cell(60,8,$getdata['prop_num'],'BR', 0, 'C');
	$pdf->Cell(45,8,$getdata['remarks'],'BR', 1, 'C');
	$count++;
	}
