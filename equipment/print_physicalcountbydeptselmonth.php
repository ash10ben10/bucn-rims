...
$geteqps = mysql_query("SELECT * FROM `equipments` WHERE YEAR(eqpdate) = '$year' AND MONTH(eqpdate) = '$month' AND remarks = 'Working' ORDER BY date_acquired DESC");
	...
	$pdf->Cell(335,8,"As at ".$mon." ".$year." in All Offices",'LR', 1, 'C');
	$pdf->SetFont('Arial','',10);
