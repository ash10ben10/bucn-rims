...
$geteqps = mysql_query("SELECT * FROM `equipments` WHERE YEAR(eqpdate) = '$year' AND dept_id = '$dept' ORDER BY date_acquired DESC");
	...
	$pdf->Cell(335,8,"As of ".$year." at ".$deptname['dept_name'],'LR', 1, 'C');
	$pdf->SetFont('Arial','',10);
