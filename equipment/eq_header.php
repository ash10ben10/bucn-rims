					...
					<div class="navbar-collapse collapse" id="bs-example-navbar-collapse-1" align="center" style="font-family: Segoe UI; font-size: 98%;">
								<div class="container-fluid">	
									<ul class="nav navbar-nav" style="margin: 2px 0 0 -15px;">
										...
										?>
										<li><a href="../equipment/eq_issued.php" data-toggle="tooltip" title="Manage Equipment and the status in the inventory."><button type="button" class="btn btn-info" style="margin-bottom:-8px; margin-top:-11px;"><i class="zmdi zmdi-washing-machine zmdi-hc-lg"></i>&nbsp;&nbsp;Equipment</button></a></li>
