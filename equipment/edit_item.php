		...
		<div class="container-fluid">
			...
			<div class="row" style="margin-top:-20px;">
				<div class="col-lg-12">
					...
					<form role="form" id="editequipmentname" method="post" name="contentForm" enctype="multipart/form-data" onsubmit="submitform(event);">
						<br />
						<div class="panel panel-default" div class="panel panel-default" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
										...
										<div class="row">
											<div class="col-lg-12">
												<div class="col-lg-4">
													...
													<input class="form-control" name="inputequipment" id="inputequipment" placeholder="Supply Name:" value="<?php print $getitems['item_name']; ?>" required />
												</div>
							...
							<div class="panel-footer" align="right">
								<button type="submit" name="editeqpitem" id="editeqpitem" class="btn btn-success"><span class="glyphicon glyphicon-floppy-disk"></span>&nbsp;Submit</button>
