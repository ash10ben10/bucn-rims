	...
	<div id="content-wrapper">
		...
		<div class="container-fluid">
			...
			<div class="row" style="margin-top:-20px;">
				<div class="col-lg-12">
					<h1 style="font-family: Calibri;">&nbsp;<i class="zmdi zmdi-plaster zmdi-hc-lg"></i>&nbsp;&nbsp;Maintain Equipment</h1>
						<form method="POST" id="maintainEqp" enctype="multipart/form-data" onsubmit="submitform(event);">
						<br />
						<div class="panel panel-default" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
							<div class="panel-heading">
								<div class="row" style="margin: 10px 0 0 0;">
									<div class="col-lg-12">
										...
										<div class="col-lg-3" style="" align="left">
											<input class="form-control" type="date" id="datesched" name="datesched" required />
										</div>
									</div>
								</div>
							</div>
							<div class="panel-body">
								<br/>
								<div class="col-lg-12">
									<p style="font-size:15px;"><i>Type the following details that will provide the service:</i></p>
											...
											<div class="col-lg-12">
												<div class="row">
													<div class="col-lg-3" style="margin-bottom: 10px;" align="left">
														<label>Company:</label>
														<input class="form-control" id="company" name="company" placeholder="Company Name" required />
													</div>
													<div class="col-lg-3" style="margin-bottom: 10px;" align="left">
														<label>Address:</label>
														<input class="form-control" id="cadd" name="cadd" placeholder="Company Address" required />
													</div>
													<div class="col-lg-3" style="margin-bottom: 10px;" align="left">
														<label>Contact Number:</label>
														<input class="form-control" name="cpnum" id="cpnum" placeholder="Company Contact No." placeholder="" pattern="([+0-9.-])+" />	
													</div>
													<div class="col-lg-3" style="margin-bottom: 10px;" align="left">
														<label>Repairer:</label>
														<input class="form-control" id="rprer" name="rprer" placeholder="Company Repairer" pattern="([A-Za-zñÑ]| |-)+" minlength="2" required />
													</div>
												</div>
											</div>
										</div>
								...
								<div class="col-lg-12">
									...
									<div class="panel panel-default">
										...
										<?php 
											...
											if($position['position_name'] == "Supply Officer"){
												$eqps = mysql_query("SELECT * FROM `equipments` WHERE `remarks` LIKE '%Working%' OR `remarks` LIKE '%Subject for New Repair%'");
											}else{
												$eqps = mysql_query("SELECT * FROM `equipments` WHERE received_by = '".$_SESSION['logged_personnel_id']."' AND `remarks` LIKE '%Working%' OR `remarks` LIKE '%Subject for New Repair%'");
											}
											
											if(mysql_num_rows($eqps) == 0){
												print "<br /><p align=center><i>You have no issued Equipment at this moment.</i></p><br />";
											}else{
												print "
												...
												while($geteqps = mysql_fetch_array($eqps)){
													...
													print "<td style='text-align:center;vertical-align:middle;'><a href='view_eq2.php?id=".$geteqps['eqp_id']."'>".$selitem['item_name'].", ".$geteqps['brand']."</td>";
							...
							<div class="panel-footer" align="right">
								...
								if($position['position_name'] == "Supply Officer"){
									...
									if(mysql_num_rows($eqps) == 0){
										?>
										<a href="../equipment/eq_pmaintenance.php" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span>&nbsp;Cancel</a>
										<?php
									}else{
										?>
										<button type="submit" name="pmnow" id="pmnow" class="btn btn-success"><span class="glyphicon glyphicon-floppy-disk"></span>&nbsp;Submit</button>
										<a href="../equipment/eq_pmaintenance.php" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span>&nbsp;Cancel</a>
										<?php
									}
								}else{
