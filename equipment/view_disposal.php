			...
			<div class="row" style="margin-top:-20px;">
				<div class="col-lg-12">
					<h1 style="font-family: Calibri;">&nbsp;<i class="zmdi zmdi-receipt zmdi-hc-lg"></i>&nbsp;&nbsp;<?php print $getdispinfo['dispnum']; ?></h1>
						<form method="POST" id="submitdisposal" enctype="multipart/form-data" onsubmit="submitform(event);">
						<br />
						<div class="panel panel-default" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
							<div class="panel-heading">
								<div class="row">
									<div class="col-lg-6" align="left">
										<a href="eq_disposal.php" class="btn btn-info"><span class="fa fa-arrow-left"></span>&nbsp;&nbsp;Go Back</a>
							...
							<div class="panel-body">
								...
								<div class="col-lg-12">
									<div class="row" style="margin: 10px 0 10px 0;font-size:15px;">
										...
										<div class="col-lg-1" style="margin:6px 0 0 0;">
											<label>Decision:</label>&nbsp;&nbsp;
											<?php //print $getdispinfo['dispstatus']; ?>
										</div>
										<div class="col-lg-3">
											<?php 
											...
											if($getdispinfo['dispstatus'] == "Pending"){
												?>
												<select class="selectpicker form-control" name="decision" id="decision" required>
												...
												print "<div style='margin:6px 0 0 0;'>";
												print $getdispinfo['dispstatus'];
												print "</div>";
											}
												...
												print "<br /><p align=center><i>Something went wrong when retrieving equipment for disposal.</i></p><br />";
													...
													while($getdata = mysql_fetch_array($dispitems)){
														...
														print "<tr>";
															...
															print "<td style='text-align:center;vertical-align:middle;'><center><a href='view_eq6.php?id=".$geteqpdetails['eqp_id']."'>".$selitem['item_name'].", ".$geteqpdetails['brand']."</a></center></td>";
							...
							<div class="panel-footer" align="right">
								...
								if($getdispinfo['dispstatus'] == "Pending"){
									?><button type="submit" name="subdisp" id="subdisp" class="btn btn-success"><span class="glyphicon glyphicon-ok"></span>&nbsp;&nbsp;Submit</button><?php
								}else{
