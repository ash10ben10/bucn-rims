	...
	<div id="content-wrapper">
		...
		<div class="container-fluid">
			...
			<div class="row" style="margin-top:-20px;">
				<div class="col-lg-12">
					<h1 style="font-family: Calibri;">&nbsp;<i class="zmdi zmdi-delete zmdi-hc-lg"></i>&nbsp;&nbsp;Equipment Disposal</h1>
						...
						<div class="panel panel-default" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
							<div class="panel-heading">
								<div class="row" style="margin-bottom:-10px;">
									<div class="col-md-12" align="left" style="margin-bottom:10px;">
										<a href="../equipment/add_disposal.php" class="btn btn-default"><i class="fa fa-plus-circle fa-fw"></i>&nbsp;&nbsp;Dispose Items</a>
										&nbsp;
									</div>
								</div>
							</div>
							<div class="panel-body">
								...
								<?php 
									...
									$showdisp = mysql_query("SELECT * FROM `eqp_disposal` ORDER BY `dispdate` DESC") or die(mysql_error());
				
									if(mysql_num_rows($showdisp) == 0){
										print "<br /><p align=center><i>There are Equipment disposal at this moment.</i></p><br />";
									}else{
											...
											while($getdata = mysql_fetch_array($showdisp)){
												$getnoeqps = mysql_fetch_array(mysql_query("SELECT count(*) FROM `eqp_disposal_items` WHERE eqpd_id = '$getdata[eqpd_id]'"))or die(mysql_error());
												
												print "<tr>";
													print "<td style='text-align:center;vertical-align:middle;'><center>".date("M d, Y", strtotime($getdata['dispdate']))."</center></td>";
													print "<td style='text-align:center;vertical-align:middle;'><center>";
													?>
													<a href="view_disposal.php?id=<?php echo $getdata['eqpd_id']; ?>"><?php print $getdata['dispnum'];?></a>
													<?php
													print "</center></td>";
													print "<td style='text-align:center;vertical-align:middle;'><center>".$getnoeqps[0]."</center></td>";
													print "<td style='text-align:center;vertical-align:middle;'><center>".$getdata['dispstatus']."</center></td>";
												print "</tr>";
											}	
									}
