						...
						<div class="panel panel-default" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
							<div class="panel-heading">
								<div class="row">
									...
									<a href="../equipment/view_eq.php?id=<?php print $geteqpdetails['eqp_id']; ?>" class="btn btn-info"><span class="fa fa-arrow-left"></span>&nbsp;&nbsp;Go Back</a>
									</div>
														...
														<td colspan="2">
															...
															<div class="table-responsive">
																<table class = "table table-striped table-bordered table-hover">
																	...
																	<?php
																		$pareqps = mysql_query("SELECT * FROM equipments WHERE icspar = 'PAR' AND ics_par_id = '$readpar_id'");
