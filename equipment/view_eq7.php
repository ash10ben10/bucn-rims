...
<head>
	...
	<?php include "vieweq_engine7.php"; ?>
	<script>
									...
									<div class="row">
										<div class="col-lg-4">
											<div id="enable_equipment_edit" class="pull-left">
												<a href="eq_enduserdisposed.php" class="btn btn-info"><span class="fa fa-arrow-left"></span>&nbsp;&nbsp;Go Back</a>
											...
											<div id="disable_equipment_edit" class="pull-left" hidden >
												<a href="eq_issued.php" class="btn btn-info"><span class="fa fa-arrow-left"></span>&nbsp;&nbsp;Go Back</a>
												<a href="view_eq.php?id=<?php echo $readeqp_id; ?>" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span>&nbsp;Cancel</a>
												...
												<td width="60%" colspan="3">
													...
													<div class="row" style="margin-left:2px; margin: 10px 2px 10px 2px;">
														<div class="col-lg-12">
															...
															<div class="col-lg-4" style="font-size:16px;margin: 10px 0 10px 0;">
																<label>Status:</label><br/><?php
																if($geteqps['remarks'] == "Working"){
																	print "Active";
																}else{
																	print $geteqps['remarks'];
																}
																?>
															</div>
													</div>
														...
														while($gethistory = mysql_fetch_array($history)){
															...
															print "<td style='text-align:center;vertical-align:middle;'><center>";
																if($gethistory['icspar'] == 'PAR'){
																	...
																	?>
																	<a href="view_disposal2.php?id=<?php print $dspform['eqpd_id']; ?>"><?php print $dspform['dispnum'];?></a>
																	<?php
																}
															print "</center></td>";
