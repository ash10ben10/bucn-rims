...
<?php
	...
	$goback = mysql_fetch_array(mysql_query("SELECT `eqpd_id` FROM `eqp_disposal_items` WHERE `eqp_id` = '$readeqp_id'"))or die(mysql_error());
...
<head>
	...
	<?php include "vieweq_engine6.php"; ?>
	<script>
									...
									<div class="row">
										<div class="col-lg-4">
											<div id="enable_equipment_edit" class="pull-left">
												<a href="view_disposal.php?id=<?php print $goback['eqpd_id']; ?>" class="btn btn-info"><span class="fa fa-arrow-left"></span>&nbsp;&nbsp;Go Back</a>
											...
											<div id="disable_equipment_edit" class="pull-left" hidden >
												<a href="view_disposal.php?id=<?php print $goback['eqpd_id']; ?>" class="btn btn-info"><span class="fa fa-arrow-left"></span>&nbsp;&nbsp;Go Back</a>
												<a href="view_eq6.php?id=<?php echo $readeqp_id; ?>" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span>&nbsp;Cancel</a>
