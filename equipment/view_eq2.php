...
<head>
	...
	<?php include "vieweq_engine2.php"; ?>
	<script>
									...
									<div class="row">
										<div class="col-lg-4">
											<div id="enable_equipment_edit" class="pull-left">
												<a href="add_pm.php" class="btn btn-info"><span class="fa fa-arrow-left"></span>&nbsp;&nbsp;Go Back</a>
											...
											<div id="disable_equipment_edit" class="pull-left" hidden >
												<a href="add_pm.php" class="btn btn-info"><span class="fa fa-arrow-left"></span>&nbsp;&nbsp;Go Back</a>
												<a href="view_eq2.php?id=<?php echo $readeqp_id; ?>" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span>&nbsp;Cancel</a>
