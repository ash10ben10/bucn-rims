	...
	<div id="content-wrapper">
		...
		<div class="container-fluid">
			...
			<div class="row" style="margin-top:-20px;">
				<div class="col-lg-12">
					<h1 style="font-family: Calibri;">&nbsp;<i class="zmdi zmdi-delete zmdi-hc-lg"></i>&nbsp;&nbsp;Disposed Equipment</h1>
						...
						<div class="panel panel-default" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
							...
							<div class="panel-body">
								...
								<?php 
									...
									$showequip = mysql_query("SELECT * FROM `equipments` WHERE received_by = '".$_SESSION['logged_personnel_id']."' AND remarks REGEXP 'Auctioned|Disposed|Pending for Disposal' ORDER BY eqpdate DESC");
									
									if(mysql_num_rows($showequip) == 0){
										print "<br /><p align=center><i>There are no Equipment undertaking disposal.</i></p><br />";
									}else{
											...
											while($getdata = mysql_fetch_array($showequip)){
												$getitem = mysql_fetch_array(mysql_query("SELECT * FROM items WHERE item_id = $getdata[item_id]")) or die(mysql_error());	
												$getunit = mysql_fetch_array(mysql_query("SELECT * FROM item_unit WHERE item_unit_id = $getitem[item_unit_id]")) or die(mysql_error());
												$getpersonnel = mysql_fetch_array (mysql_query("SELECT CONCAT (personnel_fname,' ',personnel_lname) AS full_name FROM personnel WHERE personnel_id = $getdata[received_by]"))or die(mysql_error());
												...
												print "<tr>";
													...
													?>
													<a href="view_eq7.php?id=<?php echo $getdata['eqp_id']; ?>"><?php print $getitem['item_name'].", ".$getdata['brand'];?></a>
													<?php
													print "</center></td>";
