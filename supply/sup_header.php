								...
								<div class="container-fluid">	
									<ul class="nav navbar-nav" style="margin: 2px 0 0 -15px;">
										...
										if($position['position_name'] == "Supply Officer"){
											?>
											<li><a href="../supply/sup_list.php" data-toggle="tooltip" title="Manage Supply and the status in the inventory."><button type="button" class="btn btn-info" style="margin-bottom:-8px; margin-top:-11px;"><i class="zmdi zmdi-mall zmdi-hc-lg"></i>&nbsp;&nbsp;Supply</button></a></li>
											<?php
										}else{
											?>
											<li><a href="../supply/stock_req.php" data-toggle="tooltip" title="Manage Supply and the status in the inventory."><button type="button" class="btn btn-info" style="margin-bottom:-8px; margin-top:-11px;"><i class="zmdi zmdi-mall zmdi-hc-lg"></i>&nbsp;&nbsp;Supply</button></a></li>
											<?php
										}
										?>
