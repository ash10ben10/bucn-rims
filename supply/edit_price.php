	...
	<div id="content-wrapper">
		...
		<div class="container-fluid">
			...
			<div class="row" style="margin-top:-20px;">
				<div class="col-lg-12">
					<h1 style="font-family: Calibri;">&nbsp;<i class="zmdi zmdi-money-box zmdi-hc-lg"></i>&nbsp;&nbsp;Prices for <?php print $getitems['item_name']; ?></h1>
						<form role="form" id="editsupplyprices" method="post" name="contentForm" enctype="multipart/form-data">
						<br />
						<div class="panel panel-default" div class="panel panel-default" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
							...
							<div class="panel-footer" align="right">
								<button type="submit" name="editsuprice" id="editsuprice" class="btn btn-success"><span class="glyphicon glyphicon-floppy-disk"></span>&nbsp;Submit</button>
						...
						/* if(isset($_POST['editsuprice'])){
							...
							while($mudata = mysql_fetch_array($getmu)){
								...
								print $row."&nbsp;";
								print $mudata['item_unit_id']."&nbsp;";
								print $iunit['item_unit_name']."&nbsp;";
								print $price."&nbsp;";
								print "<br/>";
								$row++;
							}
