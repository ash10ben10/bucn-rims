...
$pdf->SetFont('Arial','',10);
	...
	$pdf->Cell(190,10,'REPORT ON CRITICAL LEVEL OF INVENTORY SUPPLIES','LTR', 1, 'C');
	$pdf->SetFont('Arial','',10);
	...
	$pdf->Cell(70,10,'Description','BTR', 0, 'C');
	$pdf->SetFont('Arial','B',7);
	$pdf->Cell(20,10,'Order Point','BTR', 0, 'C');
	$pdf->Cell(20,10,'Remaining Qty','BTR', 0, 'C');
	$pdf->SetFont('Arial','B',10);
	$pdf->Cell(55,10,'Category','TBRL', 1, 'C');
	$pdf->SetFont('Arial','',10);
	...
	$pdf->Cell(70,10,$items['item_name'].", ".$stockitems['description'],'BR', 0, 'C');
	$pdf->Cell(20,10,$stockitems['order_point'],'BR', 0, 'C');
	$pdf->Cell(20,10,$stockitems['quantity'],'BR', 0, 'C');
	$pdf->Cell(55,10,$cat['category_name'],'BRL', 1, 'C');
	}			
