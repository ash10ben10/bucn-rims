	...
	<nav class="navbar navbar-default navbar-static-top" role="navigation" style="font-family: Segoe UI;">
				...
				<div>
					<img src="../engine/images/header.png" class="img-responsive" style="min-width:320px;">
				</div>
					...
					<div class="navbar-collapse collapse" id="bs-example-navbar-collapse-1" align="center" style="font-family: Segoe UI; font-size: 98%;">
								<div class="container-fluid">	
									<ul class="nav navbar-nav" style="margin: 2px 0 0 -15px;">
										...
										<li><a href="../requests/req.php" data-toggle="tooltip" title="Manage Requests and the transactions."><button type="button" class="btn btn-info" style="margin-bottom:-8px; margin-top:-11px;"><i class="zmdi zmdi-mail-send zmdi-hc-lg"></i>&nbsp;&nbsp;Requests</button></a></li>
										<?php
